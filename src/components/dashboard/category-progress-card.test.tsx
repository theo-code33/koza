...
describe("CategoryProgressCard", () => {
  it("shows label, spent over target and a progress bar", () => {
    renderWithIntl(<CategoryProgressCard category="essential" spent="500.00" target="1000.00" />);
  ...
  it("uses the soft over tone when spent exceeds target", () => {
    renderWithIntl(<CategoryProgressCard category="leisure" spent="400.00" target="300.00" />);
